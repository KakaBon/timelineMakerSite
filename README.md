...
这是一个基于 Vite 和 vis-timeline 的网页版时间轴制作工具，借助 AI 开发。
...
- 在线使用：https://kakabon.github.io/timelineMakerSite/
- 下载或克隆到本地，在项目根目录运行 `npm install` 安装依赖后，点击 `run.bat` 启动服务，并在浏览器中打开 `http://localhost:5173` 使用（需已安装 Node.js）
- 下载或克隆源码进行二次开发
